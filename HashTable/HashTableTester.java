...
public class HashTableTester {
	...
	public static void main(String[] args) {
		...
		/*
		for(int i=0;i<stud.currentSize;i++) {
			if(stud.printIndex(i)!=null) {
				System.out.println("Index " + i + ": " + stud.printIndex(i).toString());
			}
		}
		...
		for(int i=0;i<NUM_TESTS;i++) {
			if(cmp.get(i)!=null) {
				System.out.println("CMP KEY " + i + ": " + cmp.get(i).toString());
			}
		}*/
